#!/usr/bin/env python3
"""
Clean Modal MCP Server - No Async Complications
Removes all async MCP server code that's causing issues
"""
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "fastapi":
        ...
        print("Deploy with: python -m modal deploy modal_mcp_clean.py")